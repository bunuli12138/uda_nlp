...
# | epoch | lr_max_rate| lr_0.1| lr_0.01 | lr_0.001| hidden_nodes | train_loss | valid_loss |
# |  --- | --- | --- | --- | --- | --- | --- | --- | 
# | 20000 | 0.9 | 2000 | 5000 | 10000 | 20 | 0.109 | 0.202 | 
# | 20000 | 0.9 | 5000 | 10000 | 15000 | 20 | 0.070 | 0.166 | 
...
# ## 问题原因
# ### 主要原因
# - 1.神经网络深度不够，只有一层隐藏层。根据图可以看出，label的起伏比较大而且规律性低，需要更深的神经网络
# - 2.根据图中的图像走向，我觉得使用回归分析会更好，但课程内容没有涉及，不装b
# ### 次要原因
# - 1.隐藏层节点数、学习率、激活函数都可以应用更好的，但具体没有改善的办法
# - 2.数据清洗比较低级，可以使用更好的方法进行特征工程
